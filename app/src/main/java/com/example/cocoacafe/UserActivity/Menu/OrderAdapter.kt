...
class OrderAdapter (val mCtx: Context, val layoutResId: Int, val list: List<Orders>)
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val txtname = view.findViewById<TextView>(R.id.txt_img_name_user_order)
        val textPriceUser = view.findViewById<TextView>(R.id.txt_img_price_user_order)
        val viewGambarUser = view.findViewById<ImageView>(R.id.img_data_user_order)
